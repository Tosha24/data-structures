...
class ListNode {
    ...
    ListNode(int x, ListNode down){
        this.val = x;
        this.down = down;
        this.next = null;
    }
    ListNode(int x, ListNode down, ListNode next) {
        this.val = x;
        this.next = next;
        this.down = down;
    }
...
public class _FlattenLinkedList {
    ...
    public static void main(String[] args) {
        ...
        ListNode head = new ListNode(5, l1, new ListNode(10, l2, new ListNode(19, l3, new ListNode(28, l4, null))));
